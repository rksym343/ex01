                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                    	<c:if test="${empty login }">
                    		<a href="${pageContext.request.contextPath}/user/login" class="btn btn-default btn-flat">Login</a>
                    	</c:if>
                    	<c:if test="${!empty login }">
	                      <a href="${pageContext.request.contextPath}/user/logout" class="btn btn-default btn-flat">Logout</a>
	                    </c:if>
                    </div>
                  </li>
                </ul>
